...
model = joblib.load("F:/Object-detection-via-HOG-SVM-master/model_name.npy")

# Test the trained classifier on an image below!
scale = 0
detections = []
# read the image you want to detect the object in:
img= cv2.imread("F:/Object-detection-via-HOG-SVM-master/361.jpg")
...
if k == 27:             #等待按键退出
    ...
    cv2.imwrite("F:/Object-detection-via-HOG-SVM-master/test.jpg", img)
    cv2.destroyAllWindows()
