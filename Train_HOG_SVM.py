...
pos_im_path = r"F:\Object-detection-via-HOG-SVM-master\pos" # This is the path of our positive input dataset
# define the same for negatives
neg_im_path= r"F:\Object-detection-via-HOG-SVM-master\nag"
